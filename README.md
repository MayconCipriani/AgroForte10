...
🌱 Tema do Concurso
Agro forte, futuro sustentável:Tecnologia e Inovação no Campo
...
🏠 Página inicial com apresentação do 
O site busca explicar, de maneira simples e interativa, como a cadeia produtiva da cevada e do malte envolve diferentes etapas, pessoas, tecnologias e impactos positivos para a sociedade.
...
👨‍🎓 Autoria
Autor(a):maycon cipriani
Professor(a) Alexandra
...
Todos os recursos for@import url("style/header.css");
:root{
